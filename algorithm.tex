...
Aus ethischer Sicht richtig interessant wird die Betrachtung allerdings erst ab der nächsthöheren Automatisierungsstufe 3.
...
\paragraph{Level 3.}
Ab hier übernimmt das autonome System in konkret abgesteckten Fahrsituationen komplett die Beobachtung der Umgebung sowie die angemessene Reaktion auf äußere Impulse.
...
Spätestens hier eröffnen sich allerdings einige schwierige ethische Dilemmas, die so beim menschlichen Fahren aufgrund der unterschiedlichen Natur des menschlichen und maschinellen Treffens von Entscheidungen gar nicht auftreten können.
...
Tatsächlich, kann man argumentieren, muss es das sogar.
Eine solche Eventualität kann bei der Programmierung nicht einfach außen vor gelassen werden, wenn es utilitaristisch begründbar ist, dass die Betrachtung dieser Fälle positive Auswirkungen auf die Risikobilanz haben könnte.
...
Dies bedingt im Allgemeinen eine fundamental andere Sichtweise auf Verkehrsunfallfolgen, die nicht mehr nur von spontanen Fahrmanövern abhängig sind, sondern konkret im Voraus determiniert werden können (und müssen).
...
Naheliegend wäre als Ursprungsgedanke ein utilitaristischer Ansatz im Sinne einer Minimierung der negativen Folgen des Unfalls auf Leib, Leben und Eigentum möglichst vieler Menschen --
...
Die restliche Wegstrecke reicht nicht aus, um das Fahrzeug abzubremsen.
Fährt es unverändert weiter, trifft es beide Personen.
...
Nun \emph{könnte} man argumentieren, dass vor dem jungen Mädchen noch ihr ganzes Leben, ihre Familie, ihre Karriere und ihr zukünftiges Glück liegt, während die Großmutter ihr eigenes erfülltes Leben bereits in großen Teilen erleben durfte.
Dass das Leben der Großmutter natürlich genau so wertvoll ist, wie das des Kindes, sollte dabei offensichtlich sein -- dennoch gäbe es im Rahmen dieser Überlegungen Gründe, wenn auch diese moralisch absolut verwerflich sein mögen, die Diskussion bei einem unvermeidbaren Unfall in die eine oder die andere Richtung zu lenken~\cite[S. 69f.]{maurer-autonomous}.
...
Des Weiteren geht natürlich eine konkrete Situationsbewertung vor dem Hintergrund einer Klassifizierung zum Finden von allgemeingültigen Lösungen automatisch mit einem Targeting gegen bestimmte Bevölkerungsgruppen einher.
...
In gewisser Weise stellt dies auch einen Appell an die Ethik der nahen Zukunft dar:
Im Rahmen der schnelllebigen technologischen Entwicklung des gegenwärtigen Zeitalters sind dies Probleme, die in nicht allzu langer Zeit eine gewissermaßen alltagstaugliche Lösung erwarten.
...
Einem Menschen wird ja schließlich in der Fahrschule auch das Handwerk des Fahrzeugführens im Straßenverkehr beigebracht, nicht etwa ethisches und moralisches Räsonieren in den dilemmatischen Grenzfällen des Straßenverkehrs.
...
An welchem Punkt hat ein neuronales Netz, das eine algorithmische Entscheidung trifft, seine Umgebung und seine Situation verstanden?
